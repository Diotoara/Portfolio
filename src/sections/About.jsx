...
const About = () => {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('aryanjhaop@gmail.com')
        setHasCopied(true);
        setTimeout(()=>{
            setHasCopied(false);
        }, 2000)
                ...
                <div className="grid-container">
                    ...
                    <div>
                        ...
                        <p className="grid-subtext">
                            I am based in New Delhi (India) with remote work available. 
                        </p>
                ...
                <div className="grid-container">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="copy-container" onClick={handleCopy}>
                            ...
                            <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">aryanjhaop@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
